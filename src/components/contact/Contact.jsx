...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs
            .sendForm(`${import.meta.env.VITE_REACT_SERVICE_ID}`, `${import.meta.env.VITE_REACT_TEMPLATE_ID}`, formRef.current, {
